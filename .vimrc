...
" Formatting {
    ...
    autocmd FileType c,cpp,java,go,php,javascript,python,twig,xml,yml,perl,sql autocmd BufWritePre <buffer> if !exists('g:starry_keep_trailing_whitespace') | call StripTrailingWhitespace() | endif
